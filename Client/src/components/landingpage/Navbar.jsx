      ...
      {isOpen && (
        <nav className="md:hidden bg-white shadow-lg">
          <ul className="flex flex-col gap-4 px-6 py-4">
            ...
            <li>
              <button className="mt-2 border-2 border-blue-600 text-blue-600 px-4 py-1 rounded hover:bg-gradient-to-r from-blue-500 to-purple-600  transition" onClick={()=>{navigate("/login")}}>
                Login
              </button>
            </li>
          </ul>
